...
import { ClassService } from "src/modules/class/application/class.service";
...
import {
  CLASS_QUERIES_TOKEN,
  IClassQueries,
} from "src/modules/class/application/class.service.query.interfaces";
import {
  CLASS_REPOSITORY_TOKEN,
  IClassRepository,
} from "src/modules/class/domain/class.repository.interface";
import { DayOfWeek, ClassState } from "src/common/enums/domain.enums";
import { Class } from "src/modules/class/domain/class.entity";
import { Teacher } from "src/modules/class/domain/teacher";
