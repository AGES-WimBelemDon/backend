...
import { FrequencyService } from "src/modules/frequency/application/frequency.service";
import {
  FREQUENCY_QUERIES_TOKEN,
  IFrequencyQueries,
} from "src/modules/frequency/application/frequency.service.query.interfaces";
import {
  FREQUENCY_REPOSITORY_TOKEN,
  IFrequencyRepository,
} from "src/modules/frequency/domain/frequency.repository";
import { Frequency } from "src/modules/frequency/domain/frequency.entity";
